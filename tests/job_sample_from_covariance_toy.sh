#!/bin/env bash
#SBATCH --job-name=sample_cov_toy
#SBATCH --partition=shared-cpu
#SBATCH --time=8:00:00
#SBATCH --cpus-per-task=12
#SBATCH --output=sample_from_cov_toy_%A_%a.out
#SBATCH --error=sample_from_cov_toy_%A_%a.err
...
OUTPUT_FILE="oa2022_toy_${seed}.npz"
N=100000
SCRIPTARGS="-m gunflows.likelihood_sampler.generate_dataset_from_covariance -o ${OUTPUT_FILE} -c ${CONFIG_FILE} -n ${N} -t 12 -s ${seed}"
