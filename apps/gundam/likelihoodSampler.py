...
import argparse
from apps.gundam.pygundam_utils import big_vector_summary, convert_TH2D_to_TMatrix, convert_to_eigenspace, log_multivariate_normal_pdf
...
class LikelihoodSampler:
    ...
    def load_data_histograms(self):
        ...
        if self.data_is_asimov:
            ...
            print("Loading data histograms from the input root file.")
        if self.fitter_root_file is None:
