...
#SBATCH --output=logs/sample_data_%A_%a.out
#SBATCH --error=logs/sample_data_%A_%a.err
#SBATCH --mail-type=ALL

index=${SLURM_ARRAY_TASK_ID}
time=$(date +%s%N)
seed=$(($index + $time))
CONFIG_FILE="output/gundamFitter_configOa2021_With_allowEigenDecompWithBounds_shiftedOPPB.root"
...
OUTPUT_FOLDER="oa2022_data_allowEigenDecompWithBounds"
